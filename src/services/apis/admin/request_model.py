...
class AdminUpdateRequest(BaseModel):
    ...
    new_username:Optional[str] = Field(str, description="new username", max_length=15, min_length=1)
    new_password:Optional[str] = Field(str, description="new password", max_length=25, min_length=5)
    super_user_password: str = Field(str, description="super user password", max_length=25, min_length=1)
